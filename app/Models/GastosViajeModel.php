...
class GastosViajeModel extends Model
{
    ...
    protected $allowedFields = ['destino_origen', 'destino_destino', 'idunidades', 'tramo_km', 'carreta'];

    public function obtenerGastosViaje(){
        return $this->select('gastos_viaje.idgastos_viaje, gastos_viaje.tramo_km, gastos_viaje.carreta, CONCAT(des.nombre, " - ", des2.nombre) as viaje, uni.descripcion as unidad')
